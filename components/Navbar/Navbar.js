        ...
        <div className='fixed w-full shadow-xl h-20 z-[100]'>
            <div className='flex justify-between items-center w-full h-full px-2 2xl:px-16'>
                <div>
                    <ul>
                        <Link href='/'>
                            <li className='ml-10 font-extrabold text-1xl  uppercase text-sm font-mono border-b  bg-clip-text bg-gradient-to-r from-[#1e40af] to-[#0ea5e9]'>Mansoor-Ul-Hassan</li>
                        </Link>
                ...
                <div>
                    <ul className='hidden md:flex'>
                        ...
                        <Link href='/#certifications'>
                            <li className='ml-10 uppercase text-sm hover:border-b'>Certifications</li>
                        </Link>
                        <a href='/my_cv.pdf'
                            target="_blank"
                            rel="noreferrer"
            ...
            <div className={
                ...
                <div className={
                    ...
                    <div className='py-4 flex flex-col'>
                        ...
                        <div className='pt-40'>
                            <p className='uppercase tracking-widest font-bold-200 text-transparent bg-clip-text bg-gradient-to-r from-[#1e40af] to-[#0ea5e9]'>
                                Let&#39;s Connect
                            </p>
